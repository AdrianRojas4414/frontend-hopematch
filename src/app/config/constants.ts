export const TEXTOS = {
    ...
    aboutDescription2:"También crea un entorno seguro y transparente para que los padrinos apoyen a los niños y construyan vínculos reales.",
    aboutDescription3:"Cada historia, cada sonrisa, cada avance escolar o mejora en la calidad de vida de nuestros niños es gracias al apoyo y solidaridad de las almas caritativas de nuestros padrinos.",
